...
- **Subagents:** planning, implementation, test, code-review under
  `.copilot/agents/`.
- **Sensor suite:** 157 shell sensors (`tests/scripts/` + `tests/meta/`), run by
