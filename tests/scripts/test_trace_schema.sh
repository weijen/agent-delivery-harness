...
expected_numeric_keys='["harness.duration_ms","harness.exit_status","harness.incomplete_count","harness.teeth_proof_missing_count","harness.violation_count","harness.warning_count"]'
