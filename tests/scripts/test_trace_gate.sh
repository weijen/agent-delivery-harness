...
make_gate_fixture() {
  ...
  local s
  for s in lib/issue-lib.sh lib/lifecycle-runtime-lib.sh start-issue.sh lifecycle/start-issue.sh finish-issue.sh lib/finish-lib.sh lib/economics-report-lib.sh validation/check-feature-list.sh \
