...
mkdir -p "${MAIN}/scripts/trace"
cp "${ROOT}/scripts/trace/log-handback.sh" "${MAIN}/scripts/trace/log-handback.sh"
cp "${ROOT}/scripts/trace/render-action-log.sh" "${MAIN}/scripts/trace/render-action-log.sh"
